...
public class LoginAction {
	...
	private com.beacon.sms.action.ScoreAction scoreAction;
	
	private com.beacon.sms.action.UpLoadAction upLoadAction;
	
	
	public com.beacon.sms.action.ScoreAction getScoreAction() {
		return scoreAction;
	}

	public void setScoreAction(com.beacon.sms.action.ScoreAction scoreAction) {
		this.scoreAction = scoreAction;
	}

	public com.beacon.sms.action.UpLoadAction getUpLoadAction() {
		return upLoadAction;
	}

	public void setUpLoadAction(com.beacon.sms.action.UpLoadAction upLoadAction) {
